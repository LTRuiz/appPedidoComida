  ...
  return (
    <div className="app">
      ...
      <section className="categories-section" style={{ position: 'relative', padding: '0 10px'}}>
        <button onClick={() =>  scroll("left")} className="scroll-arrow left" style={arrowButtonStyle({left: '10px'})}>
          <ChevronLeft size={24} />
        </button>

        <div className="categories-grid" ref={scrollRef} style={{
          display:'flex',
          overflowX:'auto',
        ...
        <button onClick={() =>  scroll("right")} className="scroll-arrow right" style={arrowButtonStyle({right: '10px'})}>
